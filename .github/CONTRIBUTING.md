...
If you are unsure whether your proposed rule meets these criteria, [open a discussion](https://github.com/SoeldnerConsult/tofulint-ruleset-opentofu/discussions/new?category=ideas) thread first before authoring a pull request.
...
You will also need to add your rule to applicable [presets](https://github.com/SoeldnerConsult/tofulint-ruleset-opentofu/blob/main/rules/preset.go).
