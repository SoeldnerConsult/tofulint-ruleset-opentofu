...
Reference: https://github.com/SoeldnerConsult/tofulint-ruleset-opentofu/blob/v0.1.0/docs/rules/terraform_module_version.md
```
...
Reference: https://github.com/SoeldnerConsult/tofulint-ruleset-opentofu/v0.1.0/master/docs/rules/terraform_module_version.md
```
